from Nested import Hyperparameters
import pandas as pd
import sys
...
exp = Hyperparameters([f'{sys.argv[1]}'], experiment=f'{sys.argv[2]}', opposition=eval(sys.argv[3]), input_representation=f'{sys.argv[4]}')
